    ...
    <div className="min-h-screen bg-[#040402] text-white">
      ...
      <div className="pt-24 pb-12 text-center">
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto px-4">
          Reserve your perfect dining experience at Al Taj Restaurant. Join us for an unforgettable culinary journey.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#040402] border-2 border-[#D4A541] rounded-2xl p-8 lg:p-12 shadow-2xl hover:shadow-[#D4A541]/20 transition-all duration-300">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Full Name */}
              <div className="group">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Full Name *</label>
                <input
                  type="text"
                  name="fullName"
              ...
              {/* Email */}
              <div className="group">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Email Address *</label>
                <input
                  type="email"
                  name="email"
              ...
              {/* Phone Number */}
              <div className="group">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Phone Number *</label>
                <input
                  type="tel"
                  name="phoneNumber"
              ...
              {/* Date & Time */}
              <div className="group">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Preferred Date & Time *</label>
                <input
                  type="datetime-local"
                  name="dateTime"
              ...
              <div className="group relative">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Number of Guests *</label>
                <select
                  name="totalGuests"
              ...
              <div className="group relative">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Occasion Type *</label>
                <select
                  name="occasionType"
              ...
              {/* Special Requests */}
              <div className="group">
                <label className="block text-[#D4A541] text-sm font-semibold mb-2">Special Requests</label>
                <textarea
                  name="message"
              ...
              <div className="text-center pt-4">
                <p className="text-gray-400 text-xs">
                  ...
                  <span className="text-[#D4A541] hover:underline cursor-pointer hover:text-[#B8941A] transition-colors duration-300"> Terms & Conditions</span>
                </p>
              </div>
            </form>
          </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900/40 border border-gray-700 rounded-xl p-6 hover:border-[#D4A541]/50 hover:shadow-lg hover:shadow-[#D4A541]/10 transition-all duration-300">
            <h3 className="text-xl font-bold text-[#D4A541] mb-4 flex items-center">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M2 3.5A1.5 1.5 0 713.5 2h1.148a1.5 1.5 0 011.465 1.175l.716 3.223a1.5 1.5 0 01-1.052 1.767l-.933.267c-.41.117-.643.555-.48.95a11.542 11.542 0 006.254 6.254c.395.163.833-.07.95-.48l.267-.933a1.5 1.5 0 011.767-1.052l3.223.716A1.5 1.5 0 0118 15.352V16.5a1.5 1.5 0 01-1.5 1.5H15c-1.149 0-2.263-.15-3.326-.43A13.022 13.022 0 712.43 8.326 13.019 13.019 0 712 5V3.5z" clipRule="evenodd" />
              </svg>
              Need Help?
            </h3>
            <div className="text-gray-300 text-sm space-y-2">
              <p>Call us directly:</p>
              <p className="text-[#D4A541] font-semibold">+39 030 0983 508</p>
              <p className="text-[#D4A541] font-semibold">+39 340 3366 793</p>
            </div>
          </div>
