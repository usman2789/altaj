          ...
          <div className="space-y-6">
            ...
            <div className="pt-6 border-t border-[#D4A541]/20">
                ...
                <div className="flex space-x-2">
                  ...
                  {/* Instagram */}
                  <button className="w-10 h-10 bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] hover:opacity-90 rounded-lg flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {/* TikTok */}
                  <button className="w-10 h-10 bg-[#010101] hover:bg-[#222] rounded-lg flex items-center justify-center transition-colors">
