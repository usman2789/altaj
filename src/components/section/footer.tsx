          ...
          <div className="hidden lg:grid lg:grid-cols-4 lg:gap-8 xl:gap-12 p-6 lg:p-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex space-x-4">
                {/* FACEBOOK */}
                <a href="#" className="bg-transparent border-2 border-[#D4A541]/60 p-2 rounded-full hover:bg-[#D4A541] hover:border-[#D4A541] hover:scale-110 transition-all duration-300">
          ...
          <div className="lg:hidden space-y-6 p-6">
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-3 mt-4">
                {/* FACEBOOK */}
                <a href="#" className="bg-transparent border-2 border-[#D4A541]/60 p-1.5 rounded-full hover:bg-[#D4A541] hover:border-[#D4A541] hover:scale-110 transition-all duration-300 transform">
