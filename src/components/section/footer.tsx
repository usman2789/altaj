      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden space-y-6">
          ...
          <div className="text-center">
            ...
            {/* SOCIAL ICONS - Positioned after VAT number with smaller size */}
            <div className="flex justify-center space-x-3 mt-4">
              {/* FACEBOOK */}
              <a href="#" className="bg-transparent border border-white p-1.5 rounded-full hover:bg-[#D4A541] hover:border-[#D4A541] transition-colors duration-300">
...
1. LOGO ADDED: Added restaurant logo at the top of mobile footer
2. LEFT-ALIGNED HEADINGS: Quick Links, Our Menu, and Contact Us headings now align left
3. INCREASED MAP SIZE: 
   - Desktop: h-32 to h-40 (128px to 160px)
   - Mobile: h-32 to h-48 (128px to 192px)
4. CONSISTENT PADDING: All mobile sections use px-6 for uniform spacing

STRUCTURAL CHANGES:
- Logo positioned at the very top of mobile layout
- Headings use text-left instead of text-center
- Contact section content maintains left alignment
- Map size increased for better visibility
- Fixed allowFullScreen attribute syntax

RESPONSIVE BEHAVIOR:
- Desktop: Maintains original 4-column layout with larger map
- Mobile: Logo → About → VAT → Social → Quick Links → Our Menu → Contact
- All headings and content properly aligned for better mobile UX
- Larger map provides better location visibility on mobile devices

TECHNICAL FIXES:
- Changed allowFullScreen="" to allowFullScreen={true} for proper React syntax
- Maintained all existing functionality and styling
- Improved mobile user experience with better organization
*/